    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                updateTotalAmount();
                com.example.foody.cartProductAdapter cartProductAdapter =
                        new com.example.foody.cartProductAdapter(getApplicationContext(), productModelLists, cart.this);
        ...
        cart_buy_cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (totalAmount == 0) {
                    ...
                    Intent intent = new Intent(cart.this, com.example.foody.payment.class);
