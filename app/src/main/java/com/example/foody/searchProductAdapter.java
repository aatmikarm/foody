...
public class searchProductAdapter extends RecyclerView.Adapter<searchProductAdapter.ItemViewHolder> {
    ...
    private ArrayList<com.example.foody.productModelList> productModelList;
    private com.example.foody.searchProductInterface searchProductInterface;

    public searchProductAdapter(Context context, ArrayList<com.example.foody.productModelList> productModelList, com.example.foody.searchProductInterface searchProductInterface) {
    ...
    public void filterList(ArrayList<com.example.foody.productModelList> filteredList) {
