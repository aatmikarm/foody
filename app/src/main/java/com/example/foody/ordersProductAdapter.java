...
public class ordersProductAdapter extends RecyclerView.Adapter<ordersProductAdapter.ItemViewHolder> {
    ...
    public ordersProductAdapter(Context context, ArrayList<productModelList> productModelList, com.example.foody.ordersProductInterface ordersProductInterface) {
