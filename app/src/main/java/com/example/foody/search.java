...
public class search extends AppCompatActivity implements com.example.foody.searchProductInterface {
    ...
    private ArrayList<com.example.foody.productModelList> productModelLists;
    ArrayList<com.example.foody.productModelList> filteredList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_filter_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(search.this, com.example.foody.filter.class);
    ...
    private ArrayList<com.example.foody.productModelList> getAllProducts(String filter) {

        final ArrayList<com.example.foody.productModelList> productModelLists = new ArrayList<>();
        if (filter.isEmpty()) {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            com.example.foody.productModelList productModelList = new com.example.foody.productModelList();
    ...
    private void filter(String text) {
        ...
        for (com.example.foody.productModelList item : productModelLists) {
    ...
    public void searchProductOnClickInterface(int position) {
        Intent intent = new Intent(getApplicationContext(), com.example.foody.productDetails.class);
