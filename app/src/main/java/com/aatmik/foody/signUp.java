...
public class signUp extends AppCompatActivity {
    ...
    private Button signUp_Register_btn, signUp_login_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("737156429662-chqmfsus6e06vgqm447t1ptv8arcj400.apps.googleusercontent.com")
                .requestEmail()
                .build();
        ...
        signUp_login_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(signUp.this, com.aatmik.foody.signIn.class));
            }
        });
    }
