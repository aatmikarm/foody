...
public class rating extends AppCompatActivity {
    ...
    private Button rating_back_btn,rating_and_review_upload_btn;
    ...
    private com.aatmik.foody.ratingReviewAdapter ratingReviewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rating_back_btn = findViewById(R.id.rating_back_btn);
        ...
        rating_and_review_upload_btn = findViewById(R.id.rating_and_review_upload_btn);


        if (getIntent().getExtras() != null) {
            this.productId = (String) getIntent().getExtras().get("productId");
        }
        rating_and_review_upload_btn.setVisibility(View.GONE);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                rating_and_review_upload_btn.setVisibility(View.VISIBLE);
                ratingReviewAdapter = new com.aatmik.foody.ratingReviewAdapter(getApplicationContext(), ratingReviewModelLists);
                rating_and_review_rv.setAdapter(ratingReviewAdapter);
            }
        }, 3000);

        rating_back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        rating_and_review_upload_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
