...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView productRecyclerView, productPlanRecyclerView, categoriesRecyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<productPlanModelList> productPlanModelLists = getAllProductPlans();
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                productPlanRecyclerView = findViewById(R.id.productPlans_list_recycler_view);
                productPlanAdapter productPlanAdapter = new productPlanAdapter(getApplicationContext(), productPlanModelLists);
                productPlanRecyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.HORIZONTAL, false));
                productPlanRecyclerView.setAdapter(productPlanAdapter);
    ...
    private ArrayList<productPlanModelList> getAllProductPlans() {
        final ArrayList<productPlanModelList> productPlanModelLists = new ArrayList<>();
        mDb.collection("plans").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        productPlanModelList productPlanModelList = new productPlanModelList();
                        productPlanModelList.setName((String) document.get("name"));
                        productPlanModelList.setImageUrl((String) document.get("image"));
                        productPlanModelLists.add(productPlanModelList);
                    }
                }
            }
        });
        return productPlanModelLists;
    }
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (imageUrl != null) {
                    ...
                    imageViewTemp = findViewById(R.id.user_profile_iv);
