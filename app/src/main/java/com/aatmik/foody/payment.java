...
public class payment extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Button onlinePayment_btn, cashOnDelivery_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onlinePayment_btn = findViewById(R.id.onlinePayment_btn);
        cashOnDelivery_btn = findViewById(R.id.cashOnDelivery_btn);
        paymentActivity_totalPayment.setText(String.valueOf(totalAmount));

        cashOnDelivery_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cashOnDelivery_btn.setBackgroundColor(Color.argb(255, 237, 47, 101));
                onlinePayment_btn.setBackgroundColor(Color.WHITE);
                ...
                if (totalAmount == 0) {
                    ...
                    finish();
                    startActivity(new Intent(getApplicationContext(), com.aatmik.foody.orders.class));
                }
            }
        });

        onlinePayment_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onlinePayment_btn.setBackgroundColor(Color.argb(255, 237, 47, 101));
                cashOnDelivery_btn.setBackgroundColor(Color.WHITE);
                makePayment();
            }
        });
    }
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        mDb.collection("keys").document("fcm").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            @Override
                            public void onComplete(@NonNull Task<DocumentSnapshot> taskKey) {
                                if (taskKey.isSuccessful()) {
                                    DocumentSnapshot documentKeys = taskKey.getResult();
                                    if (documentKeys.exists()) {
                                        //send seller a notification message

                                        sellerToken = (String) document.get("sellerToken");
                                        String fcmKey = (String) documentKeys.get("fcm");

                                        FcmNotificationsSender notificationsSender = new FcmNotificationsSender(fcmKey,sellerToken,
                                       ...
                                       // Toast.makeText(payment.this, fcmKey, Toast.LENGTH_SHORT).show();
                                    }
