...
public class mobileNumber extends AppCompatActivity {
    ...
    private Button mobileNumber_verify_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobileNumber_verify_btn = (Button) findViewById(R.id.mobileNumber_verify_btn);

        if (getIntent().getExtras() != null) {
            this.uid = (String) getIntent().getExtras().get("uid");
        }

        mobileNumber_verify_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                startActivity(new Intent(mobileNumber.this, com.aatmik.foody.signIn.class));
                finish();
            }
        });
