...
public class productStatus extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private TextView productStatus_deliveryPersonName_tv, productStatus_total_amount_tv, productStatus_product_name, productStatus_arrivalTime, userProductOTP_tv, productStatusView_tv, paymentType_tv;
    private ImageView productStatus_deliveryPerson_iv, productStatus_image_iv;
    ...
    private Button productStatus_back_btn, productStatus_deliveryPersonCall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productStatus_arrivalTime = findViewById(R.id.productStatus_arrivalTime);
        productStatus_deliveryPerson_iv = findViewById(R.id.productStatus_deliveryPerson_iv);
        productStatus_back_btn = findViewById(R.id.productStatus_back_btn);
        ...
        productStatus_back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        ...
        handler1.postDelayed(runnable1 = new Runnable() {
            ...
            public void run() {
                if (userGeoPoint != null && sellerGeoPoint != null) {
                    ...
                    productStatus_arrivalTime.setText("Arrival Time = " + convertSecondsToTime(timeInSeconds) + " Min");
                }
